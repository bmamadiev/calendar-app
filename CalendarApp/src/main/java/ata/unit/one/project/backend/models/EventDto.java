package ata.unit.one.project.backend.models;
...
public class EventDto implements Serializable {
    ...
    public EventDto(String eventId, String eventTitle, String videoConferenceProvider, Instant startTime, Instant endTime) {
